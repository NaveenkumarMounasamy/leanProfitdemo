...
const Settings = () => {
  ...
  return (
    <Card>
      <CardHeader title='Update project details' action={<Button type='reset' size='large' color='error' variant='contained'>
        Archive
      </Button>} />
        ...
        <CardContent>
          <Grid container spacing={5}>
            ...
            <Grid item xs={12} className='d-flex'>
              ...
              >
                <FormControlLabel disabled value={2} defaultChecked control={<Radio />} label='Fixed Price' />
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth>
                <CustomSkillPicker items={ORG_UNITS} label='Organizational Units' />
              </FormControl>
            </Grid>
