      ...
      if (storedToken) {
        ...
        await axios
          ...
          .then(async response => {
            ...
            const returnUrl = router.query.returnUrl ? router.query.returnUrl : '/dashboards/analytics'
    ...
    axios
      ...
      .then(async response => {
        ...
        if (user.org == "true") {
          ...
          const returnUrl = router.query.returnUrl ? router.query.returnUrl : '/organizational-setup'
          setUser({ ...response.data.userData })
