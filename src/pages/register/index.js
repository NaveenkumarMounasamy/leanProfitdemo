          ...
          <BoxWrapper>
            ...
            />
              <FormControl fullWidth sx={{ mb: 4 }}>
                <InputLabel htmlFor='auth-login-v2-password' error={Boolean(errors.password)}>Password</InputLabel>
                <OutlinedInput
                  label='Password'
              ...
              <FormControl fullWidth sx={{ mb: 4 }}>
                <InputLabel htmlFor='auth-login-v2-confirm-password' error={Boolean(errors.confirmPassword)}>Confirm Password</InputLabel>
                <OutlinedInput
