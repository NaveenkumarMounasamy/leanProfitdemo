...
export const SKILLS = [{ name: 'Angular' }, { name: 'Asp.Net' }, { name: 'Azure' }, { name: 'Javascript' }, { name: 'Flutter' }, { name: 'Figma' }, { name: 'Python' }, { name: 'SQL' }, { name: 'Sharepoint' }, { name: 'React' }]
...
export const FEEDBACKS = [{
  ...
  description: 'I noticed I asked you for a deliverable on this key project by the end of last week. I still haven’t received this deliverable and wanted to follow up. If a deadline doesn’t work well with your bandwidth, would you be able to check in with me? I’d love to get a good idea of what you can commit to without overloading your workload.',
  member: "Naveenkumar Mounasamy",
  rating: 4
},
{
  title: 'A direct report who struggles to meet deadlines.',
  description: 'hanks for letting me know you’re running behind schedule and need an extension. I’ve noticed this is the third time you’ve asked for an extension in the past two weeks. In our next one-on-one, can you come up with a list of projects and the amount of time that you’re spending on each project? I wonder if we can see how you’re managing your time and identify efficiencies.',
  member: "Pavithra Murugesan",
  rating: 3
},
{
  title: 'Improve customer service skills.',
  description: 'Always try to exhibit creativity and flexibility in solving customers’ problems and questions.Try to address problems as quickly as possible even if it’s a demanding customer.',
  member: "Babysha Papanasam",
  rating: 2
},
{
  title: 'Give time and space for clarifying questions.',
  description: 'Constructive feedback can be hard to hear. It can also take some time to process. Make sure you give the person the time and space for questions and follow-up. ',
